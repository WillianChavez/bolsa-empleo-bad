...
import { jobOfferFormSchema, type JobOfferFormValues } from "@/lib/validators/job-offer-validator";
...
export const JobOfferForm: React.FC<JobOfferFormProps> = ({
  ...
  const form = useForm<JobOfferFormValues>({
    ...
    defaultValues: {
      ...
      fecha_limite_aplicacion: initialData?.fecha_limite_aplicacion ? new Date(initialData.fecha_limite_aplicacion) : undefined,
      estado_oferta: initialData?.estado_oferta || "Borrador",
    },
  });

  const estadosOferta: JobOfferFormValues["estado_oferta"][] = ["Borrador", "Activa", "Pausada"];
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Ej: Tech Solutions S.A. de C.V." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                        <Textarea placeholder="Ej: REST APIs, Git, Docker. Uno por línea." {...field} className="h-24 resize-y"/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                        <Textarea placeholder="Ej: Resolución de problemas, Comunicación efectiva, Trabajo en equipo. Una por línea." {...field} className="h-24 resize-y"/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
             ...
             <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                        <Textarea placeholder="Ej: 3+ años en desarrollo web, Experiencia liderando proyectos. Una por línea." {...field} className="h-24 resize-y"/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                        <Textarea placeholder="Ej: Ing. en Ciencias de la Computación (o similar), Certificaciones relevantes. Uno por línea." {...field} className="h-24 resize-y"/>
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Ej: San Salvador, Remoto (El Salvador)" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Indicar si es negociable o confidencial.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    {MODALIDADES_TRABAJO.map((modalidad: ModalidadTrabajo) => (
                      <SelectItem key={modalidad.id_modalidad} value={String(modalidad.id_modalidad)}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Control interno del estado de la publicación.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
