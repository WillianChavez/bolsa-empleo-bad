  ...
  const handleCreateJobOffer = async (values: JobOfferFormValues) => {
    ...
    if (success) {
      ...
      toast.error("Error al crear la oferta de trabajo", {
        description: "Hubo un problema al intentar guardar la oferta. Por favor, inténtalo de nuevo.",
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold tracking-tight md:text-3xl">Crear Nueva Oferta de Trabajo</h1>
