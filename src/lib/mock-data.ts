...
const mockJobOffers: JobOfferViewModel[] = [
  {
    ...
    descripcion_larga:
      'Descripción larga detallada para el puesto de Desarrollador Full-Stack Senior...',
    ...
    habilidades_requeridas:
      'Resolución de problemas, Comunicación, Trabajo en equipo',
    experiencia_requerida: '5+ años en desarrollo full-stack',
    perfil_academico:
      'Ingeniería en Sistemas, Ciencias de la Computación o afín.',
  ...
  },
  {
    ...
    requisitos:
      '- Experiencia comprobada como Ingeniero Frontend o rol similar.\\n- Dominio de HTML, CSS, JavaScript (ES6+).\\n- Fuerte experiencia con React y Next.js.\\n- Experiencia con TypeScript.\\n- Familiaridad con herramientas de versionado de código como Git.',
    conocimientos_requeridos:
      'Next.js, TypeScript, React, Redux/Zustand, TailwindCSS, GraphQL',
    habilidades_requeridas:
      'Atención al detalle, Pensamiento analítico, Creatividad',
    experiencia_requerida: '3+ años en desarrollo frontend',
    perfil_academico:
      'Licenciatura en Informática o campo relacionado. Se valorarán certificaciones.',
  ...
  },
  {
    ...
    requisitos:
      '- Recién graduado o hasta 1 año de experiencia en análisis de datos.\\n- Conocimiento de SQL.\\n- Familiaridad con Python o R para análisis de datos.\\n- Capacidad para comunicar hallazgos de manera clara.',
    conocimientos_requeridos:
      'SQL, Excel, Python/R (básico), PowerBI/Tableau (deseable)',
    habilidades_requeridas:
      'Curiosidad intelectual, Habilidades analíticas, Buena comunicación',
    experiencia_requerida: '0-1 año',
    perfil_academico:
      'Licenciatura en Estadística, Matemáticas, Economía, Informática o campo cuantitativo relacionado.',
  ...
  },
  {
    ...
    requisitos:
      '- Experiencia demostrable como Diseñador UX/UI o rol similar.\\n- Portafolio sólido que muestre proyectos de diseño UX/UI.\\n- Dominio de herramientas de diseño como Figma, Sketch o Adobe XD.\\n- Conocimiento de las mejores prácticas de UX y tendencias de diseño actuales.',
    conocimientos_requeridos:
      'Figma, Adobe XD, User Research, Wireframing, Prototyping, Design Systems',
    habilidades_requeridas:
      'Empatía, Creatividad, Comunicación visual, Colaboración',
    experiencia_requerida: '2-4 años en diseño UX/UI',
    perfil_academico:
      'Licenciatura en Diseño Gráfico, Diseño de Interacción, Psicología o campo relacionado. Cursos o certificaciones en UX/UI son una ventaja.',
...
export const fetchJobOfferById = async (
  id: number
): Promise<JobOfferViewModel | undefined> => {
  return new Promise((resolve) => {
    setTimeout(() => {
