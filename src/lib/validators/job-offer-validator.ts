...
export const jobOfferFormSchema = z.object({
  nombre_puesto: z
    ...
    .min(3, { message: "El nombre del puesto debe tener al menos 3 caracteres." })
    .max(100, { message: "El nombre del puesto no puede exceder los 100 caracteres." }),
  nombre_empresa: z
    .string({
  ...
  descripcion_corta: z
    ...
    .max(300, { message: "La descripción corta no puede exceder los 300 caracteres." }),
  descripcion_larga: z
    .string({
      required_error: "La descripción completa es requerida.",
    })
    .min(50, { message: "La descripción completa debe tener al menos 50 caracteres." }),
  requisitos: z
    .string({
      required_error: "Los requisitos son necesarios.",
    })
    .min(10, { message: "Por favor, detalla los requisitos (mín. 10 caracteres)." }),
  conocimientos_requeridos: z
    .string({
        required_error: "Los conocimientos son necesarios.",
    })
    .min(10, { message: "Por favor, detalla los conocimientos (mín. 10 caracteres)." }),
  habilidades_requeridas: z
    .string({
        required_error: "Las habilidades son necesarias.",
    })
    .min(10, { message: "Por favor, detalla las habilidades (mín. 10 caracteres)." }),
  experiencia_requerida: z
    .string({
        required_error: "La experiencia es necesaria.",
    })
    .min(5, { message: "Por favor, detalla la experiencia (mín. 5 caracteres)." }),
  perfil_academico: z
    .string({
        required_error: "El perfil académico es necesario.",
    })
    .min(10, { message: "Por favor, detalla el perfil académico (mín. 10 caracteres)." }),
  ubicacion: z
    .string({
  ...
  rango_salarial: z
    .string()
    .max(50, { message: "El rango salarial no debe exceder los 50 caracteres." })
    .optional()
