...
const CompanyRegisterForm: React.FC<CompanyRegisterFormProps> = () => {
  ...
  return (
    <Card className='mx-auto my-8 w-full max-w-lg'>
      <CardHeader>
        ...
        <CardDescription>
          ...
          empleo. Los campos marcados con{' '}
      ...
      <form onSubmit={handleCompanyRegister}>
        <CardContent className='space-y-4'>
          {error && (
            <p
              role='alert'
              className='rounded-md border border-red-300 bg-red-100 p-3 text-sm font-medium text-red-500'
            >
              {error}
            </p>
          )}
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              aria-required='true'
              aria-describedby={
                error && error.includes('Nombre de la empresa')
                  ? 'companyName-error'
                  : undefined
              }
            />
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              aria-required='true'
              aria-describedby={
                error && error.includes('correo electrónico válido')
                  ? 'email-error'
                  : undefined
              }
            />
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              aria-required='true'
              aria-describedby={
                error && error.includes('NIT válido') ? 'nit-error' : undefined
              }
            />
            {error && error.includes('NIT válido') && (
              <p id='nit-error' className='mt-1 text-xs text-red-500'>
                {error}
              </p>
            )}
          </div>
          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              <Input
                ...
                aria-required='true'
                className={
                  passwordError || (error && error.includes('Contraseña'))
                    ? 'border-red-500'
                    : ''
                }
                aria-describedby={
              ...
              <Button
                ...
                variant='ghost'
                size='sm'
                className='absolute top-1/2 right-0 h-auto -translate-y-1/2 px-3 py-2 hover:bg-transparent'
          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              <Input
                ...
                aria-describedby={
                  passwordError ? 'password-error-message' : undefined
                }
              />
              <Button
                type='button'
